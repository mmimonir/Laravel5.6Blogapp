...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                            All Available Post <span class="badge bg-blue">{{ $posts->count() }}</span>
                        </h2>
                </div>
                <div class="body">
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{-- <img src="{{ asset('storage/post/'.$post->image)}}" style="width: 100px; height: 50px;"> --}}
                                    </td>
    ...
    @endif
                                        ...
                                        <button class="btn btn-danger wave-effect" type="button" onclick="deletePost({{ $post->id }})">
